  ...
  return (
    <>
      <form
        ...
        className="fixed top-1/3 left-1/3 flex p-2 gap-6 items-center flex-col flex-wrap rounded w-2/4 min-h-44 shadow shadow-gray-700 bg-gray-800 bg-opacity-80"
      >
