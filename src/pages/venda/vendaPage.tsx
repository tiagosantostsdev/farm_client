...
export const Venda = () => {
  ...
  return (
    ...
    {openSpinner && <div className="fixed top-1/3 left-[35%] max-md:left-[40%] flex p-2 gap-6 justify-center items-center flex-col flex-wrap rounded w-2/4 min-h-44 shadow shadow-gray-700 bg-slate-900 bg-opacity-80"><Spinner/>
    <span className="text-white">Deletando...</span></div>}
        {user.usuario && (
